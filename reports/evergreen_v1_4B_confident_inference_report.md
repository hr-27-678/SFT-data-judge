...
| Field | Value |
| --- | --- |
| Run name | `evergreen__v1_4B_confident` |
| Model | `Qwen/Qwen3-4B-Instruct-2507` |
| Adapter | `C:\Users\haoran27\llamafactory_outputs\scorer_binary_confident_1000_qwen3_4b_lora_e3` |
| Output JSONL | `data\scored\evergreen_v1_4B_confident_predictions.jsonl` |
| Prompt only | False |
...
| --- | --- | --- | --- | --- | --- |
| cot_zh | 340 | 280 | 60 | 0 | 100.00% |
| finetome | 185 | 156 | 29 | 0 | 100.00% |
| openmath_reasoning | 75 | 74 | 1 | 0 | 100.00% |
