...
| Field | Value |
| --- | --- |
| Run name | `evergreen__v3_confident` |
| Model | `Qwen/Qwen3-8B` |
| Adapter | `C:\Users\haoran27\llamafactory_outputs\scorer_binary_v3_confident_qwen3_8b_lora_e3` |
| Output JSONL | `data\scored\evergreen_v3_confident_predictions.jsonl` |
| Prompt only | False |
