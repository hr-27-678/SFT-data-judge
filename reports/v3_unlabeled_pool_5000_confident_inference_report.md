...
| Field | Value |
| --- | --- |
| Run name | `scorer_binary_v3_confident_qwen3_8b_lora_e3` |
| Model | `Qwen/Qwen3-8B` |
| Adapter | `C:\Users\haoran27\llamafactory_outputs\scorer_binary_v3_confident_qwen3_8b_lora_e3` |
| Output JSONL | `data\scored\v3_unlabeled_pool_5000_confident_predictions.jsonl` |
| Prompt only | False |
...
| --- | --- | --- | --- | --- | --- |
| cot_zh | 3000 | 2022 | 978 | 0 | 100.00% |
| finetome | 1250 | 1002 | 248 | 0 | 100.00% |
| openmath_reasoning | 750 | 735 | 15 | 0 | 100.00% |
