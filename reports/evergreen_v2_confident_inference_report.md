...
| Field | Value |
| --- | --- |
| Run name | `evergreen__v2_confident` |
| Model | `Qwen/Qwen3-8B` |
| Adapter | `C:\Users\haoran27\llamafactory_outputs\scorer_binary_v2_confident_qwen3_8b_lora_e3` |
| Output JSONL | `data\scored\evergreen_v2_confident_predictions.jsonl` |
| Prompt only | False |
...
| --- | --- | --- | --- | --- | --- |
| cot_zh | 340 | 335 | 5 | 0 | 100.00% |
| finetome | 185 | 182 | 3 | 0 | 100.00% |
