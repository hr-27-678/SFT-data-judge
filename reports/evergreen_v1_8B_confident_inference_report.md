...
| Field | Value |
| --- | --- |
| Run name | `evergreen__v1_8B_confident` |
| Model | `Qwen/Qwen3-8B` |
| Adapter | `C:\Users\haoran27\llamafactory_outputs\scorer_binary_confident_1000_qwen3_8b_lora_e3` |
| Output JSONL | `data\scored\evergreen_v1_8B_confident_predictions.jsonl` |
| Prompt only | False |
...
| --- | --- | --- | --- | --- | --- |
| cot_zh | 340 | 316 | 24 | 0 | 100.00% |
| finetome | 185 | 181 | 4 | 0 | 100.00% |
